...
namespace Sirenix.OdinInspector.Editor.Drawers
{
	...
	public sealed class PropertyRangeAttributeUInt16Drawer : OdinAttributeDrawer<PropertyRangeAttribute, ushort>
	{
		...
		{
			ushort num = ((getterMinValue != null) ? getterMinValue.GetValue() : ((ushort)base.Attribute.Min));
			ushort num2 = ((getterMaxValue != null) ? getterMaxValue.GetValue() : ((ushort)base.Attribute.Max));
			...
			if (EditorGUI.EndChangeCheck())
			{
				...
				base.ValueEntry.SmartValue = (ushort)num3;
			}
		}
	}
}
