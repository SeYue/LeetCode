...
namespace Sirenix.OdinInspector.Editor.Examples
{
	internal static class InternalAttributeExampleInfoMap
	{
		public static readonly Dictionary<Type, AttributeExampleInfo[]> Map = new Dictionary<Type, AttributeExampleInfo[]>
		{
			...
			{
				typeof(DisableInNonPrefabsAttribute),
				new AttributeExampleInfo[1]
				{
					new AttributeExampleInfo
					{
			...
			{
				typeof(DisableInPrefabsAttribute),
				new AttributeExampleInfo[1]
				{
					new AttributeExampleInfo
					{
			...
			{
				typeof(DisableInPrefabInstancesAttribute),
				new AttributeExampleInfo[1]
				{
					new AttributeExampleInfo
					{
			...
			{
				typeof(DisableInPrefabAssetsAttribute),
				new AttributeExampleInfo[1]
				{
					new AttributeExampleInfo
					{
			...
			{
				typeof(HideInNonPrefabsAttribute),
				new AttributeExampleInfo[1]
				{
					new AttributeExampleInfo
					{
			...
			{
				typeof(HideInPrefabInstancesAttribute),
				new AttributeExampleInfo[1]
				{
					new AttributeExampleInfo
					{
			...
			{
				typeof(HideInPrefabAssetsAttribute),
				new AttributeExampleInfo[1]
				{
					new AttributeExampleInfo
					{
