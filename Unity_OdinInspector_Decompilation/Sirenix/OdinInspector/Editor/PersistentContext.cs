namespace Sirenix.OdinInspector.Editor
{
	...
	public static class PersistentContext
	{
		...
		public static bool GetLocal<TKey1, TValue>(TKey1 alphaKey, out LocalPersistentContext<TValue> context)
		{
			...
			bool result = Get(alphaKey, out context2);
		...
		{
			GlobalPersistentContext<TValue> context2;
			bool result = Get(alphaKey, betaKey, out context2);
			context = LocalPersistentContext<TValue>.Create(context2);
			return result;
		}
		...
		{
			GlobalPersistentContext<TValue> context2;
			bool result = Get(alphaKey, betaKey, gammaKey, out context2);
			context = LocalPersistentContext<TValue>.Create(context2);
			return result;
		}
		...
		{
			GlobalPersistentContext<TValue> context2;
			bool result = Get(alphaKey, betaKey, gammaKey, deltaKey, out context2);
			context = LocalPersistentContext<TValue>.Create(context2);
			return result;
		}
		...
		{
			GlobalPersistentContext<TValue> context2;
			bool result = Get(alphaKey, betaKey, gammaKey, deltaKey, epsilonKey, out context2);
			context = LocalPersistentContext<TValue>.Create(context2);
			return result;
		}
	}
